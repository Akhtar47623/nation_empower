...
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex m-b-10 no-block">
                            <h5 class="card-title m-b-0 align-self-center">Add Section Info</h5>
                            ...
                            <form action="{{url('/admin/home_info/store/')}}" method="POST" enctype="multipart/form-data">
                                @csrf
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="info_text" name="info_text">
  </div>

  <div class="form-group">
    <label for="info_image">Add Image(icon):</label>
    <input type="file" class="form-control" id="info_image" name="info_image" >
  </div>
