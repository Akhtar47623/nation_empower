            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive m-t-10">
                        <a class="btn btn-success" href="{{url('admin/home_section/add/')}}" role="button">Add More</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ url('/admin/home_section/view',$Home_Section_detail->id) }}"><i class="fas fa-eye"></i></a>

                                        <a href="{{ url('/admin/home_section/edit/'.$Home_Section_detail->id) }}"><i class="fas fa-edit"></i></a>

                                        <a href="{{ url('/admin/home_section/delete',$Home_Section_detail->id) }}" onclick='return confirm("Confirm delete?")'><i class="fas fa-trash-alt text-danger"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
