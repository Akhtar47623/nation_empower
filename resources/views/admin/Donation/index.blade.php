            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex m-b-10 no-block">
                        <h5 class="card-title m-b-0 align-self-center">Donations</h5>
                    ...
                    <div class="table-responsive m-t-10">
                        <table id="myTable" class="table color-table table-bordered product-table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key +1 }}</td>
                                    <td><?= date_format($donate->created_at,"d-M-Y") ?></td>
                                    <td>{{ $donate->first_name }}</td>

                                    <td class="text-center">

                                        <a href="{{ url('/admin/donation/'.$donate->id) }}"><i class="fas fa-eye"></i></a>
                                        <form style="display: inline-block;" method="POST" action="{{ url('/admin/donation',$donate->id) }}">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <!-- <a href="{{ url('/admin/donation/delete/'.$donate->id) }}" onclick='return confirm("Confirm delete?")'><i class="fas fa-trash-alt text-danger"></i></a> -->
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
