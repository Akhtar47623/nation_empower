                                ...
                                @foreach($services as $key => $service)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('/admin/services',$service->id) }}"><i class="fas fa-eye"></i></a>
                                            <a href="{{ url('admin/services/'.$service->id.'/edit/') }}"><i class="fas fa-edit"></i></a>
                                            <form style="display: inline-block;" method="POST" action="{{ url('/admin/services',$service->id) }}">
                                                @csrf
                                                @method('DELETE')
