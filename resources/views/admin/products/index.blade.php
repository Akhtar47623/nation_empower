                    ...
                    <div class="table-responsive m-t-10">
                        <table id="myTable" class="table color-table table-bordered product-table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $products_info->id }}</td>
                                    <td>{{ $products_info->product_title }}</td>
                                    <td class="text-center">
                                        <a href="{{ url('/admin/product/'.$products_info->id) }}"><i class="fas fa-eye"></i></a>

                                        <a href="{{ url('/admin/product/'.$products_info->id.'/edit/') }}"><i class="fas fa-edit"></i></a>

                                        <a href="{{ url('/admin/product/delete',$products_info->id) }}" onclick='return confirm("Confirm delete?")'><i class="fas fa-trash-alt text-danger"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
