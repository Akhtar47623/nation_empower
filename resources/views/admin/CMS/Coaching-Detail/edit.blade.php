        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{url('/admin/coaching-detail/'.$CMS_details->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        @endif
                        @if($CMS_details->subtitle != null)
                        <div class="form-group">
                            <label for="heading">SubTitle:</label>
                            <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{$CMS_details->subtitle}}">
                        </div>
                        @endif
                        @if($CMS_details->image1 != null)
                        <div class="form-group">
                            <label for="text1">image1:</label>
                            <img alt="Website Logo" style="height: 100px;width: 100px;" id="input-preview" src="{{ isset($CMS_details)?asset($CMS_details->image1):asset('images/upload.jpg') }}">
                        ...
                        <div class="form-group">
                            ...
                            <img alt="Website Logo" style="height: 100px;width: 100px;" id="input-preview" src="{{ isset($CMS_details)?asset($CMS_details->image2):asset('images/upload.jpg') }}">
                            <div class="upload-photo">
                        ...
                        <div class="form-group">
                            ...
                            <img alt="Website Logo" style="height: 100px;width: 100px;" id="input-preview" src="{{ isset($CMS_details)?asset($CMS_details->image3):asset('images/upload.jpg') }}">
                            <div class="upload-photo">
                        ...
                        @endif
                        @if($CMS_details->description2 != null)
                        <div class="form-group">
                            <label for="description">Short Description:</label>
                            <textarea class="form-control" id="description2" name="description2" rows="3">{{$CMS_details->description2}}</textarea>
                        </div>
                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <img alt="Website Logo" style="width: 400px;height: 470px;" id="input-preview" src="{{ isset($CMS_details)?asset($CMS_details->image_path):asset('images/upload.jpg') }}">
                            <div class="upload-photo">
                        ...
                        @if($CMS_details->video_path != null)
                        <div class="form-group">
                            <label for="image3">Video:</label>
                            <video width="320" height="240" controls>
                                <source src="{{ isset($CMS_details)?asset($CMS_details->video_path):asset('images/upload.jpg') }}" type="video/mp4">
                                <source src="{{ isset($CMS_details)?asset($CMS_details->video_path):asset('images/upload.jpg') }}" type="video/ogg">
