        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{url('/admin/events-content/'.$events_content->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        @if($events_content->page_name =='Events' && $events_content->page_section =='Events Section')
                            
                            <div class="form-group">
                                <label for="title">Event Title:</label>
                                <input type="text" class="form-control" id="title" name="title" value="{{$events_content->title}}">
                            </div>
                            @endif
                            <br>
