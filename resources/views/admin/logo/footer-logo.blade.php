...
<div class="container-fluid logo">
    <div class="row">
          <div class="col-lg-6 col-md-6">
              <form class="form-horizontal" method="post" action="{{url('/admin/footer-logo')}}" enctype= "multipart/form-data">
                  @csrf
                  <div class="card">
                      <div class="card-body">
                          ...
                          @endif
                          <div class="col-md-12">
                              <img alt="Website Logo" style="max-width: 340px;" id="input-preview" src="{{ asset(footerImage()) }}">
