            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex m-b-10 no-block">
                        <h5 class="card-title m-b-0 align-self-center">Add Team Member</h5>
                    ...
                    <form action="{{url('/admin/team/')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @error('name')
                            <p style="color: #f90d0d;" class="error-message">**{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                        ...
                        <h6>Socials:</h6>
                        <small><b>**Don't fill them if not provided</b></small>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tw_link" name="tw_link">
                        </div>
                        <div class="form-group">
                            <label for="LI_link">LinkedIn:</label>
                            <input type="text" class="form-control" id="LI_link" name="LI_link">
                        </div>
                        <div class="form-group">
