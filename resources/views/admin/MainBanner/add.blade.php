            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex m-b-10 no-block">
                        <h5 class="card-title m-b-0 align-self-center">Add Banner</h5>
                    ...
                    <form action="{{url('/admin/main-banner/')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="banner_description" rows="3">{{old('banner_description')}}</textarea>
                   ...
                   <!--      <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="button_name" name="button_name" value="{{old('')}}">
                            @error('button_name')
                            <p class="error-message">**{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="button_link" name="button_link" value="{{old('')}}">
                            @error('button_link')
                            <p class="error-message">**{{ $message }}</p>
                            @enderror
                        </div> --> 
