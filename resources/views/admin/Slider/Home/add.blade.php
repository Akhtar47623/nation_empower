        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{url('admin/home-slider')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                     <div class="form-group">
                            <label for="title">Title:</label>
                            <textarea type="text" class="form-control" id="title" name="title">{{old('title')}}</textarea>
                            @error('title')
                        ...
                        <div class="form-group">
                            <label for="sub_text">Button:</label>
                            <input type="text" class="form-control" id="button" name="button_name" value="{{old('button_name')}}">
                            @error('button')
                            <p class="error-message">**{{ $message }}</p>
                            @enderror
                        </div> 
                        ...
                        <div class="form-group">
                            <label for="sub_text">Slider Image:</label>
                            <br>
