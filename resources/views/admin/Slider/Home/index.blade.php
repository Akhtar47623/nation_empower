                    ...
                    <div class="d-flex m-b-10 no-block">
                        ...
                        <div class="ml-auto text-light-blue">
                            <ul class="nav nav-tabs customtab default-customtab list-inline text-uppercase lp-5 font-medium font-12" role="tablist">
                                <li>
                                    <a href="{{url('admin/home-slider/create/')}}" class="btn waves-effect waves-light btn-rounded btn-primary">Add New Slider</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                @foreach($sliders as $key => $slider)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('/admin/home-slider/'.$slider->id.'/edit/') }}"><i class="fas fa-edit"></i></a>
                                        <form style="display: inline-block;" method="POST" action="{{ url('/admin/home-slider',$slider->id) }}">
                                        @csrf
                                        @method('DELETE')
