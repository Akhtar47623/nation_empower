...
<!--                         <div class="navbar-header mt-5 ml-5">
                            <a class="navbar-brand" href="{{url('/')}}"> 
                                <img src="{{asset('assets/imgs/admin-logo.png')}}" alt="homepage" class="dark-logo"> 
                            </a> 
                        </div> -->

                            <div class="card-body p-0">
                                 <div class="  pb-5 " style="background-color:#f7941d;">
                                        </div>
                                <form method="POST" class="form bordered-input" action="{{ route('login') }}">
                                    ...
                                    <div class="p-30 pb-0 ">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input class="form-control pl-0 font-12" type="text" placeholder="email" name="email" value="{{ old('email') }}" required autofocus>
                                            </div>
                                        ...
                                        <div class="form-group row m-b-10">
                                            <div class="col-12">
                                                ...
                                                <input class="form-control font-12  pl-0 {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password" placeholder="password" value="">
                                   ...
                                   <!--     <div class="form-group row m-b-20">
                                        ...
                                        <div class="form-group row m-b-10">
                                            <div class="col-12">
                                                <button style="background-color: #f7941d;" type="submit"
