    ...
    <!-- Program Detail Start -->
      <section>
          <div class="programs-detail-sec">
              <div class="container">
                  <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12">
                          <div class="programs-detail-img">
                              <img src="{{asset('web-assets/images/program-detail-img.png')}}" align="text">
                          </div>
                          <div class="programs-detail-text">
                              <h2>{{$services->title}}</h2>
                              <p>{!!$services->long_description!!}</p>
                          </div>
                      </div>
                  </div>
              </div>
