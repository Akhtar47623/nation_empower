...
class HiringProcessController extends Controller
{
    ...
    {
        $process_content = CMS::where('page_section','Hiring Process')->get();
        return view('admin.CMS.HiringProcess.index',compact('process_content'));
    }
    public function edit($id)
    {
        $process_content = CMS::findOrFail($id);
        return view('admin.CMS.HiringProcess.edit',compact('process_content'));
    }

    public function show($id)
    {
        $process_content = CMS::findOrFail($id);
        return view('admin.CMS.HiringProcess.view',compact('process_content'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/hiring-process')->with('message', 'Content Has Been Updated!');
    }
