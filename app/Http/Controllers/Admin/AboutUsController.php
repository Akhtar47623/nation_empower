...
class AboutUsController extends Controller
{
    ...
    {
        $about_details = CMS::where('page_name','About Us')->get();
        return view('admin.CMS.About.index',compact('about_details'));
    }
    public function edit($id)
    {
        $about_details = CMS::findOrFail($id);
        return view('admin.CMS.About.edit',compact('about_details'));
    }

    public function show($id)
    {
        $about_details = CMS::findOrFail($id);
        return view('admin.CMS.About.view',compact('about_details'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/about-us')->with('message', 'Content Has Been Updated!');
    }
