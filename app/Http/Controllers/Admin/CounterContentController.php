...
class CounterContentController extends Controller
{
    ...
    {
        $counter_content = CMS::where('page_name','Counter')->get();

        return view('admin.CMS.Counter.index',compact('counter_content'));
    }
    public function edit($id)
    {
        $counter_content = CMS::findOrFail($id);
        return view('admin.CMS.Counter.edit',compact('counter_content'));
    }

    public function show($id)
    {
        $counter_content = CMS::findOrFail($id);
        return view('admin.CMS.Counter.view',compact('counter_content'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/counter-content')->with('message', 'Content Has Been Updated!');
    }
