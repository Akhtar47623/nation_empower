...
class DevelopmentContentController extends Controller
{
    public function index()
    {
        $development = CMS::where('page_name','development')->get();
        return view('admin.CMS.Development.index',compact('development'));
    }
    public function edit($id)
    {
        $development_content = CMS::findOrFail($id);
        $development = Development::where('development_id',$id)->get();
        return view('admin.CMS.Development.edit',compact('development_content','development'));
    }

    public function show($id)
    {
        $development = CMS::findOrFail($id);
        return view('admin.CMS.Development.view',compact('development'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        if ($request->development != null) {
           $development = Development::where('development_id',$id);
             $development->delete();
            foreach ($request->development as $key => $value) {
                $development =new Development;
                $development->description=$value;
                $development->development_id=$id;
                $development->save();
        ...
        return redirect('/admin/development-content')->with('message', 'Content Has Been Updated!');
    }
