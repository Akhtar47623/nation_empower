...
class EventsContentController extends Controller
{
    ...
    {
        $events_content = CMS::where('page_name','Events')->get();
        return view('admin.CMS.Events.index',compact('events_content'));
    }
    public function edit($id)
    {
        $events_content = CMS::findOrFail($id);
        return view('admin.CMS.Events.edit',compact('events_content'));
    }

    public function show($id)
    {
        $events_content = CMS::findOrFail($id);
        return view('admin.CMS.Events.view',compact('events_content'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/events-content')->with('message', 'Content Has Been Updated!');
    }
