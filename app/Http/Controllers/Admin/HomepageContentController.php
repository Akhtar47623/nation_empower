...
class HomepageContentController extends Controller
{
    ...
    {
        $homepage_content = CMS::where('page_name','Home Page')->get();
        return view('admin.CMS.Homepage.index',compact('homepage_content'));
    }
    public function edit($id)
    {
        $homepage_content = CMS::findOrFail($id);
        return view('admin.CMS.Homepage.edit',compact('homepage_content'));
    }

    public function show($id)
    {
        $homepage_content = CMS::findOrFail($id);
        return view('admin.CMS.Homepage.view',compact('homepage_content'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        if ($request->hasfile('image5')) {
            $destination6 = 'uploads/admin/CMS/'.$imagetable->image5;
        ...
        if ($request->hasfile('image6')) {
            $destination7 = 'uploads/admin/CMS/'.$imagetable->image6;
            ...
            CMS::where('id', $id)
                ->update([
                    'image6' => 'uploads/admin/CMS/'.$filename5,
                ]);
        }
        ...
        return redirect('/admin/homepage-content')->with('message', 'Content Has Been Updated!');
    }
