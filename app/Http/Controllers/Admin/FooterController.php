...
class FooterController extends Controller
{
    ...
    {
        $footer_details = CMS::where('page_name','Footer')->get();
        return view('admin.CMS.footer.index',compact('footer_details'));
    }
    public function edit($id)
    {
        $footer_details = CMS::findOrFail($id);
        return view('admin.CMS.footer.edit',compact('footer_details'));
    }

    public function show($id)
    {
        $policy_details = CMS::findOrFail($id);
        return view('admin.CMS.footer.view',compact('policy_details'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/footer-menu')->with('message', 'Content Has Been Updated!');
    }
